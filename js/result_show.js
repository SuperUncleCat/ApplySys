  ...
  function isGood(num,depart_good_check,apperant_check){
    $.ajax({
      ...
      data : {
        is_id : num,
        is_good_check : depart_good_check,
  ...
  // 部門長不許可
  function isBad(num,depart_good_check,good_check,apperant_check){
    $('#modalNotAllow').click(function(){
      if($('#reasonContent').val()){
        ...
        $.ajax({
          ...
          data : {
            is_id : num,
            depart_good_check : depart_good_check,
