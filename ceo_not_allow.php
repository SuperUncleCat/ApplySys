<?php
  ...
  $sql_update_human_is_good = "update apply_form set human_is_good=0 where id='$is_id'";
  ...
  $sql_all = "select * from apply_form where ceo_is_good=2 order by `updated_at` desc  limit 100";
  ...
  try {
    ...
    $stmt = $pdo->prepare($sql_update_human_is_good);
    $stmt->execute();
